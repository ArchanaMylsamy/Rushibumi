                                ...
                                <div class="deposit-info__input">
                                    <div class="deposit-info__input-group input-group">
                                        ...
                                        <input class="form-control form--control amount" name="amount" type="text"
                                            value="{{ old('amount', @$advertisement ? getAmount(@$advertisement->total_amount) : (@$monetization ? getAmount(gs('monetization_amount')) : '')) }}"
                                            placeholder="@lang('00.00')"
                                            @if (@$advertisement || @$monetization) readonly @endif autocomplete="off">
