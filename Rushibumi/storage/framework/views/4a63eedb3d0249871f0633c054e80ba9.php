        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    ...
                    <h2 class="title text-white"> <?php echo app('translator')->get('Sorry! Your session has expired'); ?></h2>
                    <p class="description text-white"><?php echo app('translator')->get('Please go back and refresh your browser and try again'); ?></p>
...
<?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/errors/419.blade.php ENDPATH**/ ?>