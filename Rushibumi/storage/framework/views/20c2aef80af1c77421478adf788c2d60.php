<?php $__env->startSection('app'); ?>
    <div class="home-fluid">
        <div class="home__inner">
            <?php echo $__env->make($activeTemplate . 'partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <div class="home__right">
                <?php echo $__env->make($activeTemplate . 'partials.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php if(!request()->routeIs(['user.setting.*', 'user.authorization'])): ?>
                    <div class="home-body dashboard-body">
                        <div class="dashboard-wrapper">
                            <?php if(request()->routeIs(['user.advertiser.*']) || @$advertisement): ?>
                                <?php echo $__env->make($activeTemplate . 'partials.advertiser_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make($activeTemplate . 'partials.user_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?>
                ...
                <?php else: ?>
                    <div class="home-body setting-body">
                        <div class="setting-wrapper">
                            <?php echo $__env->make($activeTemplate . 'partials.setting_menu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php echo $__env->yieldContent('content'); ?>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/templates/basic/layouts/master.blade.php ENDPATH**/ ?>