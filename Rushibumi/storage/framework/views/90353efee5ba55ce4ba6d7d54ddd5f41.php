...
<?php endif; ?>
        ...
        <?php if(!blank($trendingVideos)): ?>
            <div class="video-wrapper">
                <?php echo $__env->make($activeTemplate . 'partials.video.video_list', ['videos' => $trendingVideos], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        <?php else: ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function($) {
            'use strict';
            // for videos 
            let currentPage = "<?php echo e($trendingVideos->currentPage()); ?>";
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/templates/basic/trending_list.blade.php ENDPATH**/ ?>