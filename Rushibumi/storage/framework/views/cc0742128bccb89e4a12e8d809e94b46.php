<?php $__env->startSection('content'); ?>
    ...
    <div class="play-body">
        <div class="play-video">
            <div class="primary ps-0">
                <div class="primary__videoPlayer video-item__thumb mainVideo" data-price="<?php echo e($video->price); ?>"
                    data-video-id="<?php echo e($video->id); ?>" data-item_name="<?php echo e($video->title); ?>">
                    <?php if($purchasedTrue && $video->audience): ?>
                        <div class="hidden-content ">
                            <div class="form-group">
                                <h4><?php echo e(__(gs('vc_warning')->title)); ?></h4>
                                <p class="mb-3"><?php echo e(__(gs('vc_warning')->description)); ?> </p>
                                <button class="btn btn--base SeeBtn"><?php echo app('translator')->get('See Video'); ?></button>
                            </div>
                        </div>
                    <?php endif; ?>

                    <video class="video-player" data-amount="<?php echo e($video->price); ?>" muted playsinline
                        data-poster="<?php echo e(getImage(getFilePath('thumbnail') . '/' . $video->thumb_image)); ?>" controls>
                        <?php if($purchasedTrue): ?>
                            <?php $__currentLoopData = $video->videoFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <source src="<?php echo e(route('video.path', encrypt($file->id))); ?>" type="video/mp4"
                                    size="<?php echo e($file->quality); ?>" />

                                    
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <?php $__currentLoopData = $video->subtitles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subtitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <track src="<?php echo e(getImage(getFilePath('subtitle') . '/' . $subtitle->file)); ?>"
                                    srclang="<?php echo e($subtitle->language_code); ?>" kind="captions"
                                    label="<?php echo e($subtitle->caption); ?>" default />
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </video>
                            ...
                            <div class="premium-stock-inner">
                                <div class="left">
                                    <div class="premium-stock-price">
                                        <?php echo e(gs('cur_sym')); ?><?php echo e(showAmount($video->price, currencyFormat: false)); ?>
                ...
                <div class="primary__video-content">
                    <h4 class="primary__vtitle"><?php echo e(__($video->title)); ?></h4>

                    <div class="primary__videometa">
                        <div class="items">
                            <span class="view"> <span class="icon"><i class="fa-regular fa-eye"></i></span>
                                <?php echo e(formatNumber($video->views)); ?> <?php echo app('translator')->get('views'); ?></span>
                            <span class="date"> <span class="icon"><i class="fa-regular fa-clock"></i></span>
                                <?php echo e($video->created_at->diffForHumans()); ?></span>
                        </div>
                        <div class="meta-buttons">
                            ...
                            <div class="meta-react-wrapper">
                                <div class="meta-react-inner">
                                    <button class="meta-buttons__button reactionBtn" data-reaction="1">
                                        <span class="icon">
                                            <?php if($video->isLikedByAuthUser): ?>
                                                <i class="vti-like-fill reactionIcon"></i>
                                            <?php else: ?>
                                                <i class="vti-like reactionIcon"></i>
                                            <?php endif; ?>
                                        </span>
                                        <span class="text likeCount"><?php echo e(formatNumber($video->reactionLikeCount)); ?></span>
                                    </button>
                                    <button class="meta-buttons__button reactionBtn" data-reaction="0">
                                        <span class="icon">
                                            <?php if($video->isUnlikedByAuthUser): ?>
                            ...
                            <button class="meta-buttons__button shareBtn">
                                ...
                                <span class="text"><?php echo app('translator')->get('Share'); ?></span>
                            </button>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <button class="meta-buttons__button saveBtn">
                                    ...
                                    <span class="text"> <?php echo app('translator')->get('Save to Playlist'); ?></span>
                                </button>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="primary__channel">
                        <div class="author">
                            ...
                            <a class="author__thumb" href="<?php echo e(route('preview.channel', $video->user->slug)); ?>">
                                <img src="<?php echo e(getImage(getFilePath('userProfile') . '/' . $video->user->image, isAvatar: true)); ?>"
                                    alt="image">
                            </a>

                            <div class="author__content">
                                <a href="<?php echo e(route('preview.channel', $video->user->slug)); ?>" class="channel-name">
                                    <?php echo e($video->user->channel_name ? $video->user->channel_name : $video->user->fullname); ?>

                                </a>
                                <span class="author__subscriber"><span
                                        class="subscriberCount"><?php echo e(formatNumber($video->user->subscribers()->count())); ?></span>
                                    <?php echo app('translator')->get('Subscriber'); ?></span>
                            </div>
                        </div>


                        <?php if(@auth()->id() != $video->user_id): ?>
                            <?php
                    ...
                    <div class="primary__desc">
                        ...
                        <?php if(strlen($video->description) > $descriptionLimit): ?>
                            <button class="primary__desc-button"><?php echo app('translator')->get('Show More'); ?></button>
                        <?php endif; ?>
                    </div>

                    <div class="primary__comment d-none d-xl-block">
                        <div class="top">
                            <h5 class="comment-number"><span class="commentCount"><?php echo e(count($video->allComments)); ?></span>
                                <?php echo app('translator')->get('Comments'); ?></h5>

                            <div class="dropdown comment-sort">
                                <button class="btn btn--sm  d-flex align-items-center gap-2" type="button"
                                    id="sortDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="me-1"><?php echo app('translator')->get('Sort by'); ?></span>
                                    <i class="fas fa-sort"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="sortDropdown">
                                    <li><a class="dropdown-item sort-comments" href="javascript:void(0)"
                                            data-sort="top"><?php echo app('translator')->get('Top comments'); ?></a></li>
                                    <li><a class="dropdown-item sort-comments" href="javascript:void(0)"
                                            data-sort="newest"><?php echo app('translator')->get('Newest first'); ?></a></li>
                                    <li><a class="dropdown-item sort-comments" href="javascript:void(0)"
                                            data-sort="oldest"><?php echo app('translator')->get('Oldest first'); ?></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php if(auth()->check()): ?>
                            <div class="comment-form-wrapper">
                                <span class="comment-author">
                                    <img class="fir-image"
                                        src="<?php echo e(getImage(getFilePath('userProfile') . '/' . auth()->user()->image, isAvatar: true)); ?>"
                                        alt="image">
                                </span>
                ...
                <div class="primary__comment-list comment-box__content d-none d-xl-block">
                    <div class="comment-bow-wrapper">
                        <?php echo $__env->make($activeTemplate . 'partials.video.comments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            ...
            <div class="secondary">
                ...
                <?php if(@$relatedPlaylistVideos): ?>
                    <div class="card custom--card">
                        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <?php if(@$plan): ?>
                                    <h4 class="card-title"><?php echo app('translator')->get('Plan'); ?>: <?php echo e(__($plan->name)); ?> <?php if($palyPlaylist->title): ?>
                                            / <span class="fs-14"><?php echo app('translator')->get('Playlist-'); ?>
                                                <?php echo e(__($palyPlaylist->title)); ?></span>
                                        <?php endif; ?>
                                    </h4>
                                <?php else: ?>
                                    <h4 class="card-title"><?php echo e(__($palyPlaylist->title)); ?></h4>
                                <?php endif; ?>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    <p><?php echo app('translator')->get('videos'); ?> - <?php echo e(request()->index); ?>/<?php echo e(count($relatedPlaylistVideos)); ?></p>
                                    <?php if(
                                        !@$plan &&
                                        ...
                                        <p class="price-text"><?php echo app('translator')->get('Price'); ?> -
                                            <span><?php echo e(gs('cur_sym')); ?><?php echo e(showAmount($palyPlaylist->price, currencyFormat: false)); ?></span>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <?php if(!@$plan): ?>
                                <?php if($palyPlaylist->playlist_subscription == Status::YES && gs('is_playlist_sell')): ?>
                                    <?php if(@$isPurchased): ?>
                                        <?php echo app('translator')->get('Purchased'); ?>
                                    <?php elseif(!auth()->user() || $palyPlaylist->user_id !== auth()->id()): ?>
                                        <button class="btn btn--base btn--sm premium-stock-text purchase-now btn--purchase"
                                            type="button" data-resource="<?php echo e($palyPlaylist); ?>">
                                            <span><?php echo app('translator')->get('Purchase Now'); ?></span>
                                        </button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="card-body">
                            <div class="secondary__playlist  playlist-releted-card mt-0">
                                ...
                                <?php echo $__env->make($activeTemplate . 'partials.video.related_playlist_video', [
                ...
                <?php if(@$planPlaylists): ?>
                    <div class="card custom--card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                <h4 class="card-title mb-0"><?php echo app('translator')->get('Plan'); ?>: <?php echo e(__($plan->name)); ?> -
                                    <?php echo e($planPlaylists->count()); ?> <?php echo app('translator')->get('Playlists'); ?></h4>
                                <?php if($palyPlaylist->title): ?>
                                    <a class="see-plan-video-link" href="<?php echo e(getPlanVideoUrl($plan)); ?>">
                                        <?php echo app('translator')->get('See Plan Videos'); ?>
                        ...
                        <div class="card-body">
                            <div class=" playlist-wrapper playlist-releted-card">
                                <?php echo $__env->make($activeTemplate . 'partials.video.plan_playlist', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="secondary__playlist">
                    <?php echo $__env->make($activeTemplate . 'partials.video.related_video', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
    ...
    <?php echo $__env->make($activeTemplate . 'partials.play_video_page_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <?php echo $__env->make($activeTemplate . 'partials.login_alert_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startPush('style'); ?>
   <link rel="stylesheet" href="<?php echo e(asset($activeTemplateTrue . 'css/play-video.css')); ?>">
   <style>
...
<?php $__env->startPush('script'); ?>
    <script>
        (function($) {
            ...
            const auth = "<?php echo e(auth()->user()); ?>";
            $('.submitBtn').on('click', function(e) {
                e.preventDefault();
                const url = "<?php echo e(route('user.video.add.playlist')); ?>";
            ...
            $(document).ready(function() {
                // for vidoe player
                const purchasedTrue = "<?php echo e($purchasedTrue); ?>"
                const authVideo = "<?php echo e($video->user_id == auth()->id()); ?>"
                ...
                $(document).ready(function() {
                    singleplayer.muted = false;
                    const palyPlaylist = <?php echo json_encode(!blank($palyPlaylist), 15, 512) ?>;
                    const relatedVideo = <?php echo json_encode(@$relatedVideos[0], 15, 512) ?>;

                    singleplayer.once('ended', function() {
                        if (palyPlaylist) {
                            const currentIndex = "<?php echo e(request()->index); ?>";
                            const index = parseInt(currentIndex);
                            const relatedPlaylistVideos = <?php echo json_encode($relatedPlaylistVideos, 15, 512) ?>;

                            if (index - 1 < relatedPlaylistVideos.length) {
                                const nextVideo = relatedPlaylistVideos[index];

                                if (`<?php echo e($plan && $plan->count() > 0); ?>`) {

                                    if (`<?php echo e(!@$palyPlaylist->title); ?>`) {

                                        window.location.href =
                                            "<?php echo e(route('video.play', ['', ''])); ?>/" +
                                            nextVideo.id + "/" + nextVideo.slug +
                                            "?plan=<?php echo e(@$plan->slug); ?>&index=" + (index + 1);
                                    } else {

                                        window.location.href =
                                            "<?php echo e(route('video.play', ['', ''])); ?>/" +
                                            nextVideo.id + "/" + nextVideo.slug +
                                            "?list=<?php echo e(@$palyPlaylist->slug); ?>&index=" + (
                                                index + 1) + "&plan=<?php echo e(@$plan->slug); ?>";
                                    ...
                                    window.location.href =
                                        "<?php echo e(route('video.play', ['', ''])); ?>/" +
                                        nextVideo.id + "/" + nextVideo.slug +
                                        "?list=<?php echo e(@$palyPlaylist->slug); ?>&index=" + (index +
                                        1);
                                }
                            ...
                            if (relatedVideo && Array(relatedVideo).length > 0) {
                                window.location.href = "<?php echo e(route('video.play', ['', ''])); ?>/" +
                ...
                $(document).ready(function() {
                    let adTriggers = <?php echo json_encode($adsDurations, 15, 512) ?>.map(Number);
                    let currentAdIndex = 0;
                    let adPlaying = false;

                    let requestPending = false;
                    let adVideo = $('.adVideo');
                    let slug = "<?php echo e($video->slug); ?>"

                    function playAd(response) {
                        const adId = response.data.ad_id;
                        const encryptedVideoId = "<?php echo e(encrypt(@$video->id)); ?>";
                        adPlaying = true;
                        singleplayer.pause();
                        ...
                        adVideo.html(`
                                <video class="ad-player" playsinline  controls>
                                    ...
                                    `<div class="ad-info"><div class="ad-info__thumb"><img src="${response.data.ad_logo}">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <a href="<?php echo e(route('redirect.ad', ['', ''])); ?>/${adId}/${encryptedVideoId}" class="text-white" target="_blank" >${response.data.button_label}</a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                </div></div>` : ''}
                    ...
                    function requestAd() {
                        ...
                        $.ajax({
                            type: "get",
                            url: "<?php echo e(route('fetch.ad')); ?>",
                            data: {
                                video_id: "<?php echo e(encrypt($video->id)); ?>"
                            },
                            dataType: "json",
                            success: function(response) {
                ...
                const audience = "<?php echo e($video->audience); ?>"
                if (audience == 0) {
                    if (purchasedTrue || authVideo) {
                        singleplayer.play();
                    }
                ...
                $('.reactionBtn').on('click', function() {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(route('user.reaction', $video->id)); ?>",
                        dataType: "json",
                        data: {
                            is_like: value,
                        },
            ...
            function subscribers() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.subscribe.channel', $video->user_id)); ?>",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
                    },
            ...
            $('.watchLater').on('click', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.watch.later', $video->id)); ?>",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
                    },
            ...
            $('.comment-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.comment.submit', $video->id)); ?>",
                    data: $(this).serialize(),
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
            ...
            function loadMoreComments() {
                ...
                const commentsRoute = "<?php echo e(route('user.comment.get', $video->id)); ?>";
                $('#loading-spinner').removeClass('d-none');
                $.ajax({
            ...
            $(document).on('submit', '.reply-form', function(e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.comment.reply')); ?>",
                    data: form.serialize(),
                    headers: {
                        'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>"
                    },
            ...
            $(document).on('click', '.commentReaction', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.comment.like.dislike')); ?>/" + commentId,
                    dataType: "json",
                    data: {
                        is_like: value,
            ...
            $('#shareModal').on('hidden.bs.modal', function() {
                ...
                $('.copyText').val('<?php echo e(route('video.play', [$video->id, $video->slug])); ?>');
            });
            ...
            if (!auth) {
                ...
                $(document).on('click', '.purchase-now', function(e) {
                    ...
                    modal.find('input[name="amount"]').val(parseFloat(playlist.price).toFixed(2)).trigger(
                        'input');
                    modal.find('.item-price').text(`${parseFloat(playlist.price)} <?php echo e(gs('cur_text')); ?>`);
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/templates/basic/play_video.blade.php ENDPATH**/ ?>