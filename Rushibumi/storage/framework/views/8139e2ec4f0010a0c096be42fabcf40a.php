        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-8 text-center">
                    ...
                    <h2 class="title text-white"> <?php echo app('translator')->get('Sorry! Internal server error'); ?></h2>
                    <p class="description text-white"><?php echo app('translator')->get('Something went wrong on our end. We\'re working on fixing it.'); ?></p>
...
<?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/errors/500.blade.php ENDPATH**/ ?>