...
<?php if($customCaptcha): ?>
    <div class="form-group">
        ...
        <label class=" <?php if($level): ?> form--label <?php else: ?> form-label <?php endif; ?> "><?php echo app('translator')->get('Captcha'); ?></label>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/partials/captcha.blade.php ENDPATH**/ ?>