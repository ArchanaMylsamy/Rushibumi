        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    <img class="w-100" src="<?php echo e(asset('assets/errors/images/error-404.png')); ?>" alt="image">
                    <h2 class="title text-white"> <?php echo app('translator')->get('Page not found'); ?></h2>
                    <p class="description text-white"><?php echo app('translator')->get('page you are looking for doesn\'t exist or an other error ocurred'); ?> <br> <?php echo app('translator')->get('or temporarily unavailable.'); ?></p>
                    <div class="d-flex justify-content-center">
                        <a href="<?php echo e(route('home')); ?>" class="btn error-btn btn--base outline mt-4">
                            <span class="icon">
                            ...
                            <span class="text"> <?php echo app('translator')->get('Go to Home'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/errors/404.blade.php ENDPATH**/ ?>