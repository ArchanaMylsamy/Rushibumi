            ...
            <div class="container">
                <div class="account-form style-lg">
                    <div class="account-form__heading">
                        <h3 class="account-form__title"><?php echo e(__($pageTitle)); ?></h3>
                    </div>
                    <div class="account-form__body">
                        <form method="POST" action="<?php echo e(route('user.channel.data.submit')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="profile-upload-wrapper">
                                <div class="profile-picture-upload">
                                    <div class="profile-picture-preview">
                                        <img id="profilePreview" src="<?php echo e(getImage(getFilePath('userProfile') . '/' . (auth()->user()->image ?? 'default.png'), null, true)); ?>" alt="Profile Picture">
                                    </div>
                                    <label for="profile_image" class="btn-select-picture">
                                        <?php echo app('translator')->get('Select picture'); ?>
                            ...
                            <div class="channel-form-fields">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form--control" required name="channel_name"
                                        value="<?php echo e(old('channel_name', auth()->user()->display_name ?? auth()->user()->firstname ?? '')); ?>" 
                                        placeholder="<?php echo app('translator')->get('Enter channel name'); ?>">
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Handle'); ?></label>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn--base">
                                    <?php echo app('translator')->get('Create Channel'); ?>
                                </button>
                            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/templates/basic/user/channel/form.blade.php ENDPATH**/ ?>