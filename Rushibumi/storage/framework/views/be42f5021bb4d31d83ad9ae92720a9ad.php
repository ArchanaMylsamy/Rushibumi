            ...
            <div class="container">
                <div class="account-form">
                    <div class="account-form__heading">
                        ...
                        <p class="account-form__text"><?php echo e(__(@$auth->data_values->login_page_title)); ?></p>
                    </div>
...
<?php endif; ?>
                            ...
                            <div class="d-flex flex-wrap justify-content-between">
                                ...
                                <div class="form-group">
                                    <a class="forgot-pass" href="<?php echo e(route('user.password.request')); ?>">
                            ...
                            <?php if(gs('registration')): ?>
                                <p class="text-center other-login mt-3"><?php echo app('translator')->get('Don\'t have any account?'); ?>
                                    <a class="text--base mb-0 " href="<?php echo e(route('user.register')); ?>"><?php echo app('translator')->get('Register'); ?></a>
                                </p>
                            <?php endif; ?>
                        </form>
                    </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Rushibumi\Rushibumi\core\resources\views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>